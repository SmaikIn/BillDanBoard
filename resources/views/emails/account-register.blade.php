...
<head>
    ...
    <title>Регистрация в нашем сервисе</title>
</head>
...
<table cellpadding="0" cellspacing="0" border="0" align="center" width="600"
    ...
    <tr>
        <td align="center" style="padding: 20px;">
            ...
            <h2 style="text-align: center; margin-top: 20px;">Спасибо за регистрацию!</h2>
            <p style="text-align: center;">Мы рады приветствовать вас в нашем сервисе.</p>
